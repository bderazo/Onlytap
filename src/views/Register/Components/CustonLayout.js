...
import BotonRegister from "../../.././compontents/common/BotonRegister.js";
import styles from "./CustonLayout.module.css";
import {
  ModelCoverPhono,
  ModelPictureProfile,
  ModelAccreditation,
...
function CustomLayaout() {
  ...
  useEffect(() => {
    ...
    if (
      ...
      setTwitter(storedValueInstragram);
    ...
    <div>
      <div className={`${styles.container} py-2 px-5`}>
        <h1 className="fw-bold">
          <strong>Crea y personaliza tu primera tarjeta</strong>{" "}
        </h1>
        <p>
  ...
  <div className={styles.linea}>
    <div className="mx-2" onClick={() => setShowModalPaypal(true)}>
      <BotonRegister icon="logo-paypal" name="PayPal" />
    </div>
    <div className="mx-2" onClick={() => setShowModalVenmo(true)}>
      <BotonRegister icon="logo-venmo" name="Venmo" />
    </div>
    <div className="mx-2" onClick={() => setShowModalCash(true)}>
      <BotonRegister icon="logo-usd" name="CashApp" />
    </div>
  </div>
</div> */}
      </div>
